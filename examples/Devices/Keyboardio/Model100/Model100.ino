...
KEYMAPS(
  ...
  (___,          Key_1, Key_2, Key_3, Key_4, Key_5, LCTRL(Key_Spacebar),
   ...
   AppSwitcher_Next, M(MACRO_ANY), Key_6, Key_7, Key_8,     Key_9,         Key_0,         LockLayer(NUMPAD),
  ...
  (___,          Key_1,         Key_2,     Key_3,      Key_4, Key_5, LCTRL(Key_Spacebar),
   ...
   AppSwitcher_Next,   Key_6, Key_7, Key_8, Key_9, Key_0, LockLayer(NUMPAD),
   Key_Enter,      Key_F, Key_G, Key_C, Key_R, Key_L, Key_Slash,
		   Key_D, TD(0), Key_T, Key_N, Key_S, Key_Minus,
   LGUI(LCTRL(Key_Slash)),   Key_B, Key_M, Key_W, Key_V, Key_Z, Key_Equals,
   Key_RightShift, Key_LeftAlt, Key_Spacebar, Key_RightControl,
   ShiftToLayer(FUNCTION)),
...
#error "No default keymap defined. You should make sure that you have a line like '#define PRIMARY_KEYMAP_QWERTY' in your sketch"
  ...
  (___,      Key_F1,           Key_F2,      Key_F3,     Key_F4,        Key_F5,           Key_CapsLock,
   Key_Tab,  LSHIFT(LCTRL(Key_Tab)),  Key_mouseUp, LCTRL(Key_Tab),   Key_mouseBtnR, Key_mouseWarpEnd, Key_mouseWarpNE,
   Key_Home, Key_mouseL,       Key_mouseDn, Key_mouseR, Key_mouseBtnL, Key_mouseWarpNW,
   Key_End,  Key_PrintScreen,  Key_Insert,  ___,        Key_mouseBtnM, Key_mouseWarpSW,  Key_mouseWarpSE,
   ___, Key_Delete, ___, ___,
   ___,

   TD(1),   Key_F6,                 Key_F7,                   Key_F8,                   Key_F9,          Key_F10,          Key_F11,
   Key_LeftArrow,    Consumer_ScanNextTrack, Key_LeftCurlyBracket,     Key_RightCurlyBracket,    Key_LeftBracket, Key_RightBracket, Key_F12,
                               Key_LeftArrow,          Key_DownArrow,            Key_UpArrow,              Key_RightArrow,  ___,              ___,
   LALT(LCTRL(Key_LeftArrow)),          LALT(LCTRL(Key_RightArrow)),          Consumer_VolumeDecrement, Consumer_VolumeIncrement, ___,             Key_Backslash,    Key_Pipe,
...
void setup() {
  ...
  QUKEYS(
    ...
    kaleidoscope::plugin::Qukey(0, KeyAddr(2, 9), ShiftToLayer(2))   // Q/layer-shift (on `fn`)
  )
